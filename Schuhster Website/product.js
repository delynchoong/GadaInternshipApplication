...
function updateDisplay()
{
	...
	if (!selectedCombination['unavailable'] && productShowPrice == 1)
	{
		...
		if (productPriceDisplay > 0) {
                 ...
                 /*************************************************************************************************************************************************/
                 /***********************EDITED BY LILIN FOR VIEW DETAILS PAGE NOT SHOWING PRICE FOR PRODUCTS WITH COMBINATION ERROR ******************************/

                       our_price = formatCurrency(productPriceDisplay * currencyRate, currencyFormat, currencySign, currencyBlank);
                }  else {
                        our_price = formatCurrency(productPrice * currencyRate, currencyFormat, currencySign, currencyBlank);
                }
